...
const ProjectsAndCurriculumComponent = () => {
  return(
    <div className='fixed bottom-0 flex flex-col max-[768px]:h-[60vh] gap-5'>
      <div className="max-[425px]:mx-auto h-[10%] ml-5">
        <h1 className="text-5xl text-white font-bold">Projetos</h1>
      </div>

      <div className='flex flex-col h-[90%] w-screen'>

        <div className="bg-green-300 flex h-[50%] min-[769px]:clip-path-polygon-[0_0,_100%_0,_95%_100%,_0_100%]">
              ...
              <div className='flex flex-col w-full items-center justify-evenly'>
                  ...
                  <p className='text-black text-justify text-lg max-w-[70%]'>O Meal Match usa a API da Spoonacular para  buscar por receitas baseado nos
                                              ingredientes que você listar. <br/>
                                              Encontre receitas com os ingredientes que você já tem em casa com Meal Match!
                                              </p>
                  <div className='flex w-[300px] justify-between items-center max-[375px]:w-[250px]'>
                    <GoMarkGithub className="h-20 w-20 fill-black cursor-pointer"/>
                    <button className='p-2 w-32 h-16 border border-black rounded-lg hover:bg-black hover:text-white active:bg-transparent active:text-black transition-all'>Ir para app</button>
                  </div>
              </div>
        </div>
          ...
          <div className='flex bg-purple-300 h-[50%]'>
            ...
            <div className='flex flex-col w-full items-center justify-evenly'>
              ...
              <p className='text-black text-justify text-lg max-w-[70%]'>Aplicativo de Notas desenvolvido em Next.js usando a T3 Stack.<br/>
